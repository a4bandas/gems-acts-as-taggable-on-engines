...
Fork from https://github.com/mbleigh/acts-as-taggable-on and add hack to use on engine 'Gauge'.

## ToDo
- Remove hack to use on any engine
- Impre generator migration to use any table name
