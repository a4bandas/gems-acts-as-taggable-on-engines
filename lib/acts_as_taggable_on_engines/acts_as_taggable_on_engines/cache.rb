module ActsAsTaggableOnEngines::Taggable
  module Cache
    def self.included(base)
      ...
      base.send :include, ActsAsTaggableOnEngines::Taggable::Cache::InstanceMethods
      base.extend ActsAsTaggableOnEngines::Taggable::Cache::ClassMethods

      base.class_eval do
        before_save :save_cached_tag_list
      end

      base.initialize_acts_as_taggable_on_engines_cache
    end

    module ClassMethods
      def initialize_acts_as_taggable_on_engines_cache
      ...
      def acts_as_taggable_on_engines(*args)
        super(*args)
        initialize_acts_as_taggable_on_engines_cache
      end
