...
describe "Taggable To Preserve Order" do
  ...
  it "should return tag list in the order the tags were created" do
    ...
    @taggable.instance_variable_get("@tag_list").instance_of?(ActsAsTaggableOnEngines::TagList).should be_true

    lambda {
      @taggable.save
    }.should change(ActsAsTaggableOnEngines::Tag, :count).by(3)
...
describe "Taggable" do
  ...
  it "should be able to create tags" do
    ...
    @taggable.instance_variable_get("@skill_list").instance_of?(ActsAsTaggableOnEngines::TagList).should be_true
  ...
  it "should not care about case" do
    ...
    ActsAsTaggableOnEngines::Tag.all.size.should == 1
  ...
  describe "grouped_column_names_for method" do
    it "should return all column names joined for Tag GROUP clause" do
      @taggable.grouped_column_names_for(ActsAsTaggableOnEngines::Tag).should == "tags.id, tags.name"
    end
